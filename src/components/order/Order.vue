            ...
            <el-table :data="orderList" border stripe>
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        ...
                        <el-button type="success" @click="showProgressBox" size="mini" icon="el-icon-location"></el-button>
                    </template>
                </el-table-column>
            </el-table>
            <!-- 分页区域 -->
...
export default {
    ...
    methods: {
        ...
        // 修改订单地址
        async updateAddress() {
            const consigneeAddr = this.addressForm.address1.join(' ') + ' ' + this.addressForm.address2
            const { data: res} = await this.$http.put('orders/'+this.addressForm.id, { consigneeAddr: consigneeAddr })
            if(res.code === 200) {
