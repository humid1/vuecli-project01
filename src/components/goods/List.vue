       ...
       <!-- 面板屑导航区域 -->
        ...
        <el-card>
            ...
            <el-table :data="goodsList" border stripe>
                ...
                <el-table-column label="商品价格(￥)" prop="gsellPrice" width="100px"></el-table-column>
                <el-table-column label="商品库存" prop="gstockQuantity" width="100px"></el-table-column>
                ...
                <el-table-column label="操作" width="120px">
                    <template slot-scope="scope">
                        <el-button type="primary" size="mini" icon="el-icon-edit" @click="goEditpage(scope.row.gid)"></el-button>
                        <el-button type="danger" size="mini" icon="el-icon-delete" @click="removeById(scope.row.gid)"></el-button>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
